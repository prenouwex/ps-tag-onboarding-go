...
import (
	...
	"github.com/wexinc/ps-tag-onboarding-go/models"
)
...
/*
CreateUserBadRequest MessageErr
...
type CreateUserBadRequest struct {
	...
	/*
	  In: Body
	*/
	Payload *models.MessageErr `json:"body,omitempty"`
}
...
func (o *CreateUserBadRequest) WithPayload(payload *models.MessageErr) *CreateUserBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create user bad request response
func (o *CreateUserBadRequest) SetPayload(payload *models.MessageErr) {
	o.Payload = payload
}
...
/*
CreateUserInternalServerError MessageErr
...
func (o *CreateUserInternalServerError) WithPayload(payload *models.MessageErr) *CreateUserInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create user internal server error response
func (o *CreateUserInternalServerError) SetPayload(payload *models.MessageErr) {
	o.Payload = payload
}
